...
describe('CollapsibleComponent', () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [CollapsibleComponent, TranslateModule.forRoot(), FontAwesomeTestingModule],
            providers: [],
        }).compileComponents();
    ...
    it('content has class show after collapse', () => {
        const header = fixture.debugElement.query(By.css('.collapsible-header')).nativeElement;
        header.click();
        fixture.detectChanges();
        const content = fixture.debugElement.query(By.css('.collapsible-content')).nativeElement;
